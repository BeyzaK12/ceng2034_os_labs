...
I wanted to write a bash script code, but when I wanted to add new lines with "echo" command to /etc/grub.d/40_custom, terminal gave an error message: Permission denied. I tried to give all permissions but I could not be successful. Even so I am adding this bash script code file.
...
beyza@beyzak12:~$ sudo hd -n 512 /dev/sda
...
000001b0  cd 10 ac 3c 00 75 f4 c3  c3 fa 24 99 00 00 80 20  |...<.u....$.... |
000001c0  21 00 83 fe ff ff 00 08  00 00 00 f0 bf 03 00 00  |!...............|
000001d0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|
*
000001f0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 55 aa  |..............U.|
00000200

beyza@beyzak12:~$ sudo hd -n 512 /dev/sda &> ~/myMBR.txt
beyza@beyzak12:~$ 
